...
Three price tiers, and each of them is sometimes the right one:

- **€500 – €3,500: the quick dashboard.** Straight on one clean source,
  standard visuals, you maintain it yourself. Fine for an operational
  overview on a system that's already correct.
- **€5,000 – €10,000: the serious dashboard.** With a data model under the
  hood, one pinned-down definition per figure shown, and attention for the
  people who'll use it. My own package sits in this tier:
  [from €7,500](/en/services/dashboards).
- **€15,000 and (well) beyond: dashboard plus foundation.** Once figures
  from multiple systems have to agree, you're no longer really buying a
  dashboard but a data warehouse with reporting on top. Dutch market
  research prices that scenario around €17,500 — my honest take on it is in
