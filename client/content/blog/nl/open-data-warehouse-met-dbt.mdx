...
date: "2026-07-26"
excerpt: "Dashboards falen zelden op de visualisatie en bijna altijd op het fundament eronder. Daarom bouw ik in de openbaarheid een warehouse op Nederlandse open data — met alles erop en eraan."
...
gesproken af achter de firewall van een opdrachtgever. Daarom bouw ik het in de
openbaarheid na, op data die van ons allemaal is: **`nl-open-data-warehouse`**,
een end-to-end analyseplatform op Nederlandse open data.
