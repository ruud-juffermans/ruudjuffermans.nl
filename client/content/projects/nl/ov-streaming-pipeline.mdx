...
duration: "3 weken"
repo: "https://github.com/datavakwerk/ov-streaming-pipeline"
proves: "reporting-automation"
stats:
  - { label: "Duurtest", value: "24 uur non-stop" }
  - { label: "Vensters", value: "5 minuten" }
  - { label: "Foutpad", value: "DLQ + replay" }
---
