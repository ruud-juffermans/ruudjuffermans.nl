...
*Eigen project, gebouwd om mijn aanpak te laten zien — geen betaalde klantopdracht. Alles wat hier staat is echt en na te lezen in de repo.*
...
- [x] Architectuurdiagram en lineage-documentatie in de README
- [x] Publicatiepagina op de marts (Evidence)
- [x] Eén `make`-commando van lege map tot bevraagbaar warehouse
