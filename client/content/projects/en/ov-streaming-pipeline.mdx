...
- [x] Producer, raw archive and Kafka backbone
- [x] Windowed processor with DLQ and idempotent sink
- [x] Live dashboard with delay map
- [x] Observability: Prometheus and Grafana with dashboards for lag, throughput and DLQ depth
- [x] 24-hour run survived; measured throughput and screen recording in the README
