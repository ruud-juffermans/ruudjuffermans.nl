...
*Own project, built to show how I approach AI systems — not paid client work. The design choices are the actual story: they decide whether a RAG system becomes trustworthy or a black box.*
...
- [x] Ingest: fetching and parsing rulings, with rate limiting and retries
- [x] Index: chunking with section numbers preserved, embeddings and vector store
- [x] Query: retrieval and answer generation with mandatory citations
- [x] CLI for the whole chain: `ingest`, `index`, `ask`
- [x] Evaluation set with recall and citation-correctness measurement in CI
