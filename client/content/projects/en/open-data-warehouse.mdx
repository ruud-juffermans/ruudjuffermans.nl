...
*Own project, built to show how I work — not paid client work. Everything described here is real and verifiable in the repo.*
...
- [x] Architecture diagram and lineage documentation in the README
- [x] Published page on the marts (Evidence)
- [x] One `make` command from empty directory to queryable warehouse
